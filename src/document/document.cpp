...
static void   check_mouse_click(objDocument *, DOUBLE X, DOUBLE Y);
static void   check_mouse_pos(objDocument *, DOUBLE, DOUBLE);
static void   check_mouse_release(objDocument *, DOUBLE X, DOUBLE Y);
