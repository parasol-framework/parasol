...
static ERROR  notify_disable_surface(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, APTR Args);
static ERROR  notify_enable_surface(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, APTR Args);
static ERROR  notify_focus_surface(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, APTR Args);
static ERROR  notify_free_event(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, APTR Args);
static ERROR  notify_lostfocus_surface(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, APTR Args);
static ERROR  notify_redimension_surface(OBJECTPTR Object, ACTIONID ActionID, ERROR Result, struct acRedimension *Args);
