...
#undef MOD_IDL
#define MOD_IDL "s.FontList:pNext:FontList,sName,ucPoints[0],sStyles,cScalable,cReserved1,wReserved2\nc.FSS:ALL=0xffffffff,LINE=0xfffffffe\nc.FTF:REQUIRE_SCALED=0x4,ITALIC=0x40000000,REQUIRE_FIXED=0x8,BOLD=0x20000000,SCALABLE=0x10000000,ANTIALIAS=0x10,SMOOTH=0x10,HEAVY_LINE=0x20,BASE_LINE=0x100,QUICK_ALIAS=0x40,PREFER_SCALED=0x1,CHAR_CLIP=0x80,ALLOW_SCALE=0x200,PREFER_FIXED=0x2,KERNING=0x80000000\n"
