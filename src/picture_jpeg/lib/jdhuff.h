...
typedef struct {		/* Bitreading working state within an MCU */
  ...
  LONG bytes_in_buffer;	/* # of bytes remaining in source buffer */
...
#define BITREAD_STATE_VARS  register bit_buf_type get_buffer; register int bits_left; bitread_working_state br_state
