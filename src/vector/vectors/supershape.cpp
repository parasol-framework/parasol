...
static const FieldArray clVectorShapeFields[] = {
   ...
   { "M",          FDF_VIRTUAL|FDF_DOUBLE|FDF_RW, 0, (APTR)SUPER_GET_M,  (APTR)SUPER_SET_M },
   { "N1",         FDF_VIRTUAL|FDF_DOUBLE|FDF_RW, 0, (APTR)SUPER_GET_N1, (APTR)SUPER_SET_N1 },
   { "N2",         FDF_VIRTUAL|FDF_DOUBLE|FDF_RW, 0, (APTR)SUPER_GET_N2, (APTR)SUPER_SET_N2 },
   { "N3",         FDF_VIRTUAL|FDF_DOUBLE|FDF_RW, 0, (APTR)SUPER_GET_N3, (APTR)SUPER_SET_N3 },
   ...
   { "R",  FDF_SYNONYM|FDF_VIRTUAL|FDF_VARIABLE|FDF_DOUBLE|FDF_PERCENTAGE|FDF_RW, 0, (APTR)SUPER_GET_Radius,  (APTR)SUPER_SET_Radius },
   END_FIELD
};
