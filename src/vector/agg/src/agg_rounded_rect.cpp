...
rounded_rect::rounded_rect(double x1, double y1, double x2, double y2, double rx, double ry) :
   m_x1(x1), m_y1(y1), m_x2(x2), m_y2(y2), m_rx1(rx), m_ry1(ry), m_rx2(rx), m_ry2(ry),
...
void rounded_rect::radius(double rx_bottom, double ry_bottom, double rx_top, double ry_top)
{
...
void rounded_rect::radius(double rx1, double ry1, double rx2, double ry2, double rx3, double ry3, double rx4, double ry4)
{
