...
FDEF argsReadPainter[] = { { "Void", FD_VOID }, { "Scene", FD_OBJECTPTR }, { "IRI", FD_STR }, { "FRGB:RGB", FD_PTR|FD_STRUCT }, { "Gradient", FD_OBJECTPTR|FD_RESULT }, { "Image", FD_OBJECTPTR|FD_RESULT }, { "Pattern", FD_OBJECTPTR|FD_RESULT }, { 0, 0 } };
