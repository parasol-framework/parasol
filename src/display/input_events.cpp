...
static ERROR gfxSubscribeInput(FUNCTION *Callback, OBJECTID SurfaceFilter, LONG InputMask, OBJECTID DeviceFilter, LONG *Handle)
{
...
static void input_event_loop(HOSTHANDLE FD, APTR Data) // Data is not defined
{
