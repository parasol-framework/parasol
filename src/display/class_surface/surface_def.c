...
static const struct FieldDef clSurfaceFlags[] = {
   ...
   { "Precopy", 0x00000800 },
   { "Video", 0x00001000 },
   { "WriteOnly", 0x00001000 },
   { "NoHorizontal", 0x00002000 },
   { "NoVertical", 0x00004000 },
   { "Cursor", 0x00008000 },
   { "Pointer", 0x00008000 },
   { "ScrollContent", 0x00010000 },
   { "AfterCopy", 0x00020000 },
   { "ReadOnly", 0x00028040 },
   { "Volatile", 0x00028800 },
   { "FixedBuffer", 0x00040000 },
   { "PervasiveCopy", 0x00080000 },
   { "NoFocus", 0x00100000 },
   { "FixedDepth", 0x00200000 },
   { "TotalRedraw", 0x00400000 },
   { "Composite", 0x00800000 },
   { "NoPrecomposite", 0x00800000 },
   { "PostComposite", 0x00800000 },
   { "FullScreen", 0x01000000 },
   { "IgnoreFocus", 0x02000000 },
   { "InitOnly", 0x032c1d81 },
   { "AspectRatio", 0x04000000 },
   { NULL, 0 }
};
