...
FDEF maReadClientMsg[] = { { "Message", FD_PTR|FD_RESULT }, { "Length", FD_INT|FD_RESULT }, { "Progress", FD_INT|FD_RESULT }, { "CRC", FD_INT|FD_RESULT }, { 0, 0 } };
FDEF maWriteClientMsg[] = { { "Message", FD_BUFFER|FD_PTR }, { "Length", FD_INT|FD_BUFSIZE }, { 0, 0 } };
