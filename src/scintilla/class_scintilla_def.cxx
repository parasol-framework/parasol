...
static const struct ActionArray clScintillaActions[] = {
   ...
   { AC_Disable, (APTR)SCINTILLA_Disable },
   { AC_Draw, (APTR)SCINTILLA_Draw },
   { AC_Enable, (APTR)SCINTILLA_Enable },
   { AC_Focus, (APTR)SCINTILLA_Focus },
   { AC_Free, (APTR)SCINTILLA_Free },
   { AC_Hide, (APTR)SCINTILLA_Hide },
   { AC_Init, (APTR)SCINTILLA_Init },
   { AC_NewObject, (APTR)SCINTILLA_NewObject },
   { AC_NewOwner, (APTR)SCINTILLA_NewOwner },
   { AC_Redo, (APTR)SCINTILLA_Redo },
   { AC_SaveToObject, (APTR)SCINTILLA_SaveToObject },
