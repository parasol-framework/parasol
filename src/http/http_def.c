...
static const struct FieldDef clHTTPFlags[] = {
   ...
   { "LogAll", 0x00000200 },
   { "SSL", 0x00000400 },
   { "DisableServerVerify", 0x00000800 },
   { nullptr, 0 }
};
