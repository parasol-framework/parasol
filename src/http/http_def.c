...
#undef MOD_IDL
#define MOD_IDL "c.HGS:READING_HEADER=0x0,AUTHENTICATING=0x1,AUTHENTICATED=0x2,SENDING_CONTENT=0x3,SEND_COMPLETE=0x4,READING_CONTENT=0x5,COMPLETED=0x6,TERMINATED=0x7,END=0x8\nc.HTM:TRACE=0x5,MK_COL=0x6,B_COPY=0x7,B_DELETE=0x8,B_MOVE=0x9,B_PROP_FIND=0xa,B_PROP_PATCH=0xb,COPY=0xc,LOCK=0xd,MOVE=0xe,NOTIFY=0xf,OPTIONS=0x10,POLL=0x11,GET=0x0,POST=0x1,PUT=0x2,HEAD=0x3,DELETE=0x4,UNSUBSCRIBE=0x17,UNLOCK=0x16,SUBSCRIBE=0x15,SEARCH=0x14,PROP_PATCH=0x13,PROP_FIND=0x12\nc.HOM:READ_WRITE=0x1,READ=0x1,DATA_FEED=0x0,WRITE=0x1\nc.HTS:MULTIPLE_CHOICES=0x12c,MOVED_PERMANENTLY=0x12d,FOUND=0x12e,SEE_OTHER=0x12f,NOT_MODIFIED=0x130,USE_PROXY=0x131,TEMP_REDIRECT=0x133,BAD_REQUEST=0x190,UNAUTHORISED=0x191,PAYMENT_REQUIRED=0x192,FORBIDDEN=0x193,NOT_FOUND=0x194,METHOD_NOT_ALLOWED=0x195,NOT_ACCEPTABLE=0x196,PROXY_AUTHENTICATION=0x197,REQUEST_TIMEOUT=0x198,CONFLICT=0x199,GONE=0x19a,LENGTH_REQUIRED=0x19b,PRECONDITION_FAILED=0x19c,ENTITY_TOO_LARGE=0x19d,URI_TOO_LONG=0x19e,UNSUPPORTED_MEDIA=0x19f,OUT_OF_RANGE=0x1a0,EXPECTATION_FAILED=0x1a1,SERVER_ERROR=0x1f4,NOT_IMPLEMENTED=0x1f5,BAD_GATEWAY=0x1f6,SERVICE_UNAVAILABLE=0x1f7,GATEWAY_TIMEOUT=0x1f8,VERSION_UNSUPPORTED=0x1f9,CONTINUE=0x64,SWITCH_PROTOCOLS=0x65,OKAY=0xc8,CREATED=0xc9,ACCEPTED=0xca,UNVERIFIED_CONTENT=0xcb,NO_CONTENT=0xcc,RESET_CONTENT=0xcd,PARTIAL_CONTENT=0xce\nc.HTF:NO_HEAD=0x10,NO_DIALOG=0x20,RAW=0x40,DEBUG_SOCKET=0x80,RESUME=0x1,SSL=0x400,MESSAGE=0x2,DEBUG=0x200,MOVED=0x4,RECV_BUFFER=0x100,REDIRECTED=0x8\n"
