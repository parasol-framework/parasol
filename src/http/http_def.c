...
static const struct FieldDef clHTTPMethod[] = {
   ...
   { "Bdelete", 0x00000009 },
   { "Bmove", 0x0000000a },
   { "Bpropfind", 0x0000000b },
   { "Bproppatch", 0x0000000c },
   { "Copy", 0x0000000d },
   { "Lock", 0x0000000e },
   { "Move", 0x0000000f },
   { "Notify", 0x00000010 },
...
static const struct FieldDef clHTTPFlags[] = {
   ...
   { "SSL", 0x00000200 },
   { "DisableServerVerify", 0x00000400 },
   { nullptr, 0 }
};
