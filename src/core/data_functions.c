...
FDEF argsBase64Encode[] = { { "Result", FD_LONG }, { "rkBase64Encode:State", FD_PTR|FD_STRUCT|FD_RESOURCE }, { "Input", FD_BUFFER|FD_PTR }, { "InputSize", FD_LONG|FD_BUFSIZE }, { "Output", FD_BUFFER|FD_STR }, { "OutputSize", FD_LONG|FD_BUFSIZE }, { 0, 0 } };
