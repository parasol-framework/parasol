...
FDEF argsAdjustLogLevel[] = { { "Result", FD_LONG }, { "Delta", FD_LONG }, { 0, 0 } };
...
FDEF argsAsyncAction[] = { { "Error", FD_LONG|FD_ERROR }, { "Action", FD_LONG }, { "Object", FD_OBJECTPTR }, { "Args", FD_PTR }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
...
FDEF argsGetMessage[] = { { "Error", FD_LONG|FD_ERROR }, { "Type", FD_LONG }, { "Flags", FD_LONG }, { "Buffer", FD_BUFFER|FD_PTR }, { "Size", FD_LONG|FD_BUFSIZE }, { 0, 0 } };
...
FDEF argsIdentifyFile[] = { { "Error", FD_LONG|FD_ERROR }, { "Path", FD_STR }, { "Filter", FD_LONG|FD_UNSIGNED }, { "Class", FD_LONG|FD_UNSIGNED|FD_RESULT }, { "SubClass", FD_LONG|FD_UNSIGNED|FD_RESULT }, { 0, 0 } };
...
FDEF argsReallocMemory[] = { { "Error", FD_LONG|FD_ERROR }, { "Memory", FD_PTR }, { "Size", FD_LONG|FD_UNSIGNED }, { "Address", FD_PTR|FD_ALLOC|FD_RESULT }, { "ID", FD_LONG|FD_RESULT }, { 0, 0 } };
...
FDEF argsResolvePath[] = { { "Error", FD_LONG|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_LONG }, { "Result", FD_CPP|FD_STR|FD_RESULT }, { 0, 0 } };
...
FDEF argsScanMessages[] = { { "Error", FD_LONG|FD_ERROR }, { "Handle", FD_LONG|FD_RESULT }, { "Type", FD_LONG }, { "Buffer", FD_BUFFER|FD_PTR }, { "Size", FD_LONG|FD_BUFSIZE }, { 0, 0 } };
...
FDEF argsUpdateMessage[] = { { "Error", FD_LONG|FD_ERROR }, { "Message", FD_LONG }, { "Type", FD_LONG }, { "Data", FD_BUFFER|FD_PTR }, { "Size", FD_LONG|FD_BUFSIZE }, { 0, 0 } };
