...
#undef MOD_IDL
#define MOD_IDL "s.Regex:zsPattern,zsError_msg,lFlags\nc.REGEX:AWK=0x10,DOT_ALL=0x4,EXTENDED=0x8,GREP=0x20,ICASE=0x1,MULTILINE=0x2\nc.RMATCH:CONTINUOUS=0x20,FORMAT_FIRST_ONLY=0x100,FORMAT_NO_COPY=0x80,NOT_BEGIN_OF_LINE=0x1,NOT_BEGIN_OF_WORD=0x4,NOT_END_OF_LINE=0x2,NOT_END_OF_WORD=0x8,NOT_NULL=0x10,PREV_AVAILABLE=0x40\n"
