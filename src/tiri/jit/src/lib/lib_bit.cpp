...
extern int luaopen_bit(lua_State* L)
{
   ...
   reg_iface_prototype("bit", "tobit", { TiriType::Num }, { TiriType::Num });
   reg_iface_prototype("bit", "bnot", { TiriType::Num }, { TiriType::Num });
   reg_iface_prototype("bit", "bswap", { TiriType::Num }, { TiriType::Num });
   reg_iface_prototype("bit", "lshift", { TiriType::Num }, { TiriType::Num, TiriType::Num });
   reg_iface_prototype("bit", "rshift", { TiriType::Num }, { TiriType::Num, TiriType::Num });
   reg_iface_prototype("bit", "arshift", { TiriType::Num }, { TiriType::Num, TiriType::Num });
   reg_iface_prototype("bit", "rol", { TiriType::Num }, { TiriType::Num, TiriType::Num });
   reg_iface_prototype("bit", "ror", { TiriType::Num }, { TiriType::Num, TiriType::Num });
   reg_iface_prototype("bit", "band", { TiriType::Num }, { TiriType::Num }, FProtoFlags::Variadic);
   reg_iface_prototype("bit", "bor", { TiriType::Num }, { TiriType::Num }, FProtoFlags::Variadic);
   reg_iface_prototype("bit", "bxor", { TiriType::Num }, { TiriType::Num }, FProtoFlags::Variadic);
   reg_iface_prototype("bit", "tohex", { TiriType::Str }, { TiriType::Num, TiriType::Num });
