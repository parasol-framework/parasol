...
// emit_global_decl_stmt is implemented in ir_emitter/emit_decl.cpp

// emit_local_function_stmt is implemented in ir_emitter/emit_decl.cpp

// emit_function_stmt is implemented in ir_emitter/emit_decl.cpp
...
// emit_plain_assignment is implemented in ir_emitter/emit_assignment.cpp

// emit_compound_assignment is implemented in ir_emitter/emit_assignment.cpp

// emit_if_empty_assignment is implemented in ir_emitter/emit_assignment.cpp

// emit_if_nil_assignment is implemented in ir_emitter/emit_assignment.cpp
...
// emit_pipe_expr is implemented in ir_emitter/emit_call.cpp
...
// emit_safe_call_expr is implemented in ir_emitter/emit_call.cpp

// emit_call_expr is implemented in ir_emitter/emit_call.cpp

// optimise_assert is implemented in ir_emitter/emit_call.cpp

// emit_result_filter_expr is implemented in ir_emitter/emit_call.cpp

// emit_table_expr is implemented in ir_emitter/emit_table.cpp

// emit_range_expr is implemented in ir_emitter/emit_table.cpp

// emit_choose_expr is implemented in ir_emitter/emit_choose.cpp

// emit_function_expr is implemented in ir_emitter/emit_function.cpp

// emit_function_lvalue is implemented in ir_emitter/emit_function.cpp
...
// prepare_assignment_targets is implemented in ir_emitter/emit_assignment.cpp
...
// emit_annotation_registration is implemented in ir_emitter/emit_function.cpp
...
//********************************************************************************************************************
// Include method implementations from separate files for better code organisation.
// These files contain the largest method implementations to keep the main file manageable.
