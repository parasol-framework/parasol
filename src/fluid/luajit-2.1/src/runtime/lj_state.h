...
[[nodiscard]] inline constexpr ptrdiff_t savestack(lua_State* L, const TValue* p) noexcept
{
   return (const char*)(p) - mref(L->stack, char);
}

[[nodiscard]] inline constexpr TValue* restorestack(lua_State* L, ptrdiff_t n) noexcept
{
