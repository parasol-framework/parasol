...
// Format parser.
LJ_FUNC [[nodiscard]] SFormat LJ_FASTCALL lj_strfmt_parse(FormatState* fs);
...
// Raw conversions.
LJ_FUNC [[nodiscard]] char* LJ_FASTCALL lj_strfmt_wint(char* p, int32_t k);
LJ_FUNC [[nodiscard]] char* LJ_FASTCALL lj_strfmt_wptr(char* p, const void* v);
LJ_FUNC [[nodiscard]] char* LJ_FASTCALL lj_strfmt_wuleb128(char* p, uint32_t v);
...
LJ_FUNCA [[nodiscard]] GCstr* LJ_FASTCALL lj_strfmt_num(lua_State* L, cTValue* o);
LJ_FUNCA [[nodiscard]] GCstr* LJ_FASTCALL lj_strfmt_number(lua_State* L, cTValue* o);
#if LJ_HASJIT
LJ_FUNC [[nodiscard]] GCstr* LJ_FASTCALL lj_strfmt_char(lua_State* L, int c);
#endif
LJ_FUNC [[nodiscard]] GCstr* LJ_FASTCALL lj_strfmt_obj(lua_State* L, cTValue* o);
