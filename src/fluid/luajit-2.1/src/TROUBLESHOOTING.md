...
The simplest way to debug generated bytecode is to create an isolated `.fluid` testing file and then run parasol with the `--jit-options dump-bytecode` option.
