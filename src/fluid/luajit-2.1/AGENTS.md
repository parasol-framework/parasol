...
build/agents/src/fluid/luajit-generated/  # Generated headers, VM object, host helpers
...
parasol --no-crash-handler --log-warning your_script.fluid
```
...
- Run compiled-in unit tests: `src/fluid/tests/test_unit_tests.fluid` with `--log-api`
...
- **Subtle regressions**: Fluid tests often surface LuaJIT semantic changes as script regressions rather than crashes.
...
2. **Force rebuild**: After modifying `MMDEF`, delete the generated VM files:
   ```bash
   # Windows
   del build\agents\src\fluid\luajit-generated\buildvm.exe
   del build\agents\src\fluid\luajit-generated\lj_vm.obj

   # Unix
   rm build/agents/src/fluid/luajit-generated/buildvm
   rm build/agents/src/fluid/luajit-generated/lj_vm.o
   ```
