...
#undef MOD_IDL
#define MOD_IDL "s.SurfaceControl:lListIndex,lArrayIndex,lEntrySize,lTotal,lArraySize\ns.SurfaceInfo:lParentID,lBitmapID,lDataMID,lDisplayID,lFlags,lX,lY,lWidth,lHeight,lAbsX,lAbsY,wLevel,cBitsPerPixel,cBytesPerPixel,lLineWidth\ns.SurfaceList:lParentID,lSurfaceID,lBitmapID,lDisplayID,lDataMID,lTaskID,lRootID,lPopOverID,lFlags,lX,lY,lWidth,lHeight,lLeft,lRight,lBottom,lTop,wLevel,wLineWidth,cBytesPerPixel,cBitsPerPixel,cCursor,ucOpacity\ns.SurfaceCoords:lX,lY,lWidth,lHeight,lAbsX,lAbsY\nc.DRAG:ANCHOR=0x1,NORMAL=0x2,NONE=0x0\nc.IRF:RELATIVE=0x8,IGNORE_NV_CHILDREN=0x1,IGNORE_CHILDREN=0x2,SINGLE_BITMAP=0x4,FORCE_DRAW=0x10\nc.DSF:NO_DRAW=0x1,NO_EXPOSE=0x2\nc.EXF:REDRAW_VOLATILE=0x2,REDRAW_VOLATILE_OVERLAP=0x4,CURSOR_SPLIT=0x10,CHILDREN=0x1,ABSOLUTE_COORDS=0x8,ABSOLUTE=0x8\nc.SWIN:HOST=0x0,TASKBAR=0x1,ICON_TRAY=0x2,NONE=0x3\nc.ARF:NO_DELAY=0x8,UPDATE=0x4,READ=0x1,WRITE=0x2\nc.RT:ROOT=0x1\nc.RNF:POST_COMPOSITE=0x1000000,FULL_SCREEN=0x2000000,VIDEO=0x2000,WRITE_ONLY=0x2000,NO_HORIZONTAL=0x4000,ASPECT_RATIO=0x8000000,INIT_ONLY=0x6583981,HOST=0x800,PRECOPY=0x1000,VOLATILE=0x51000,TRANSPARENT=0x1,NO_VERTICAL=0x8000,STICK_TO_BACK=0x2,IGNORE_FOCUS=0x4000000,STICK_TO_FRONT=0x4,CURSOR=0x10000,VISIBLE=0x8,SCROLL_CONTENT=0x20000,STICKY=0x10,AFTER_COPY=0x40000,GRAB_FOCUS=0x20,FIXED_BUFFER=0x80000,HAS_FOCUS=0x40,PERVASIVE_COPY=0x100000,FAST_RESIZE=0x80,NO_FOCUS=0x200000,DISABLED=0x100,FIXED_DEPTH=0x400000,REGION=0x200,TOTAL_REDRAW=0x800000,AUTO_QUIT=0x400,READ_ONLY=0x50240,POINTER=0x10000,COMPOSITE=0x1000000,NO_PRECOMPOSITE=0x1000000\nc.BDF:REDRAW=0x2,SYNC=0x1,DITHER=0x4\nc.LVF:EXPOSE_CHANGES=0x1\n"
