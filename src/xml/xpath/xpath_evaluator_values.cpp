//********************************************************************************************************************
// XPath Evaluator Value and Expression Logic
//********************************************************************************************************************
//
// This translation unit contains the routines responsible for turning evaluated AST nodes into
// concrete XPathValue instances.  It owns the comparison helpers, node-set manipulation logic, and
// the full expression interpreter covering unions, predicates, arithmetic and FLWOR evaluation.  The
// navigation-oriented primitives live in dedicated files so that this unit can focus purely on value
// semantics and schema-aware conversions.
//
...
using namespace xpath::evaluator::detail;
