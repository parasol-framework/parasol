...
#undef MOD_IDL
#define MOD_IDL "s.XMLAttrib:sName,sValue\ns.XMLTag:lIndex,lID,pChild:XMLTag,pPrev:XMLTag,pNext:XMLTag,pPrivate,pAttrib:XMLAttrib,wTotalAttrib,uwBranch,lLineNo\nc.XMI:PREV=0x0,PREVIOUS=0x0,CHILD=0x1,NEXT=0x2,CHILD_END=0x3,END=0x4\nc.XSF:CHECK_SORT=0x4,REPORT_SORTING=0x2,DESC=0x1\nc.XMF:INCLUDE_COMMENTS=0x2,STRIP_CONTENT=0x4,LOWER_CASE=0x8,UPPER_CASE=0x10,READABLE=0x20,INDENT=0x20,LOCK_REMOVE=0x40,STRIP_HEADERS=0x80,NEW=0x100,NO_ESCAPE=0x200,ALL_CONTENT=0x400,PARSE_HTML=0x800,STRIP_CDATA=0x1000,DEBUG=0x2000,PARSE_ENTITY=0x4000,WELL_FORMED=0x1,INCLUDE_SIBLINGS=0x80000000\nc.XMS:UPDATE_ONLY=0xfffffffe,NEW=0xffffffff,UPDATE=0xfffffffd\n"
