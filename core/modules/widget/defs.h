...
extern void free_dialog(void);
extern void free_fileview(void);
extern void free_image(void);
extern void free_input(void);
extern void free_menubar(void);
