...
#ifdef __cplusplus
LUALIB_API int luaL_typerror [[ noreturn ]] (lua_State *L, int narg, const char *tname);
LUALIB_API int luaL_argerror [[ noreturn ]] (lua_State *L, int numarg, const char *extramsg);
#else
