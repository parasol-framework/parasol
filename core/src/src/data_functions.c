...
FDEF argsActionMsg[] = { { "Error", FD_LONG|FD_ERROR }, { "Action", FD_LONG }, { "Object", FD_OBJECTID }, { "Args", FD_PTR }, { "MessageID", FD_LONG }, { "ClassID", FD_LONG }, { 0, 0 } };
...
FDEF argsAddMsgHandler[] = { { "Error", FD_LONG|FD_ERROR }, { "Custom", FD_PTR }, { "MsgType", FD_LONG }, { "Routine", FD_FUNCTIONPTR }, { "Handle", FD_PTR|FD_RESULT }, { 0, 0 } };
...
FDEF argsCopyFile[] = { { "Error", FD_LONG|FD_ERROR }, { "Source", FD_STR }, { "Dest", FD_STR }, { 0, 0 } };
...
FDEF argsFreeMemory[] = { { "Error", FD_LONG|FD_ERROR }, { "Address", FD_PTR }, { 0, 0 } };
FDEF argsFreeMemoryID[] = { { "Error", FD_LONG|FD_ERROR }, { "ID", FD_LONG }, { 0, 0 } };
...
FDEF argsGetClassID[] = { { "Result", FD_LONG }, { "Object", FD_OBJECTID }, { 0, 0 } };
...
FDEF argsIdentifyFile[] = { { "Error", FD_LONG|FD_ERROR }, { "Path", FD_STR }, { "Mode", FD_STR }, { "Flags", FD_LONG }, { "Class", FD_LONG|FD_RESULT }, { "SubClass", FD_LONG|FD_RESULT }, { "Command", FD_STR|FD_ALLOC|FD_RESULT }, { 0, 0 } };
FDEF argsKeyGet[] = { { "Error", FD_LONG|FD_ERROR }, { "KeyStore:Store", FD_PTR|FD_STRUCT|FD_RESOURCE }, { "Key", FD_LONG }, { "Data", FD_PTR|FD_RESULT }, { "Size", FD_LONG|FD_BUFSIZE|FD_RESULT }, { 0, 0 } };
FDEF argsKeyIterate[] = { { "Error", FD_LONG|FD_ERROR }, { "KeyStore:Store", FD_PTR|FD_STRUCT|FD_RESOURCE }, { "Index", FD_LONG }, { "Key", FD_LONG|FD_RESULT }, { "Data", FD_PTR|FD_RESULT }, { "Size", FD_LONG|FD_BUFSIZE|FD_RESULT }, { 0, 0 } };
FDEF argsKeySet[] = { { "Error", FD_LONG|FD_ERROR }, { "KeyStore:Store", FD_PTR|FD_STRUCT|FD_RESOURCE }, { "Key", FD_LONG }, { "Data", FD_BUFFER|FD_PTR }, { "Size", FD_LONG|FD_BUFSIZE }, { 0, 0 } };
...
FDEF argsMoveFile[] = { { "Error", FD_LONG|FD_ERROR }, { "Source", FD_STR }, { "Dest", FD_STR }, { 0, 0 } };
...
FDEF argsRemoveMsgHandler[] = { { "Error", FD_LONG|FD_ERROR }, { "Handle", FD_PTR }, { 0, 0 } };
...
FDEF argsSaveImageToFile[] = { { "Error", FD_LONG|FD_ERROR }, { "Object", FD_OBJECTPTR }, { "Path", FD_STR }, { "Class", FD_LONG }, { "Permissions", FD_LONG }, { 0, 0 } };
...
FDEF argsStrHash[] = { { "Result", FD_LONG }, { "String", FD_STR }, { "CaseSensitive", FD_LONG }, { 0, 0 } };
...
FDEF argsUTF8ReadValue[] = { { "Result", FD_LONG }, { "String", FD_STR }, { "Length", FD_LONG|FD_RESULT }, { 0, 0 } };
...
const struct Function glFunctions[] = {
   ...
   { (APTR)FreeMemory, "FreeMemory", argsFreeMemory },
   { (APTR)FreeMemoryID, "FreeMemoryID", argsFreeMemoryID },
