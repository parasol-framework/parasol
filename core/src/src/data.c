...
#else
   char glRootPath[SIZE_SYSTEM_PATH] = ""; // In Windows, this information is read from the registry.  If there are no registry entries, the system path is the program's working directory.
