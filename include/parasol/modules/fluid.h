...
enum class JOF : uint32_t {
   ...
   PROFILE = 0x00000004,
   TRACE_TOKENS = 0x00000008,
   TRACE_EXPECT = 0x00000010,
   TRACE_BOUNDARY = 0x00000020,
   TRACE_OPERATORS = 0x00000040,
   TRACE_REGISTERS = 0x00000080,
   TRACE_CFG = 0x00000100,
   TRACE_ASSIGNMENTS = 0x00000200,
   TRACE_VALUE_CATEGORY = 0x00000400,
   TRACE_TYPES = 0x00000800,
   TRACE = 0x00000ff8,
};
